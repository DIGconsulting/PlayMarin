...
const Closerlook = () => {
  return (
    <>
		...
		>Southern Marin - A closer look</h2>
		<p style={{
			display: `flex`,
			justifyContent: `center`,
			textAlign: 'center',
		}}
		> Tw0 cities, Marin City and Mill Valley
are only 4 miles apart, but they are vastly different
across race, income, and recreation.</p>
